/// <reference path="../../../../softalert2.d.ts"/>
 ...
 * @param {SoftAlertOptions['inputAttributes']} inputAttributes
 */
...
/**
 * @param {SoftAlertOptions['input']} inputType
 * @returns {HTMLElement}
 */
 ...
 * @param {SoftAlertOptions['inputValue']} inputValue
 */
...
/** @type {Record<string, (input: Input | HTMLElement, params: SoftAlertOptions) => Input>} */
...
renderInputType.textarea = (textarea, params) => {
  ...
  // https://github.com/softinvest/softalert2/issues/2291
  setTimeout(() => {
    // https://github.com/softinvest/softalert2/issues/1699
