...
import Swal from '../../src/softalert2'
...
describe('Miscellaneous tests', function () {
  ...
  it('should throw console warning about invalid params', () => {
    ...
    expect(spy.calledWith('SoftAlert2: Unknown parameter "invalidParam"')).to.be.true
  })

  it('should throw console error about unexpected params', () => {
    const spy = cy.spy(console, 'error')
    Swal.fire('Hello world!', { icon: 'success' })
    expect(spy.calledWith('SoftAlert2: Unexpected type of html! Expected "string" or "Element", got object')).to.be
      .true
  })
