...
describe('customClass', () => {
  ...
  it('should throw console warning about unexpected type of customClass', () => {
    ...
    expect(
      spy.calledWith('SoftAlert2: Invalid type of customClass.title! Expected string or iterable object, got "object"')
    ).to.be.true
    expect(
      spy.calledWith('SoftAlert2: Invalid type of customClass.popup! Expected string or iterable object, got "number"')
    ).to.be.true
  })
})
