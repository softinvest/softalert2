...
describe('image', () => {
  it('imageUrl, imageWidth, imageHeight', () => {
    Swal.fire({
      imageUrl: 'https://github.com/softinvest/softalert2/images/swal2-logo.png',
      imageWidth: 498,
      imageHeight: 84,
    })
    expect(Swal.getImage().src).to.equal('https://github.com/softinvest/softalert2/images/swal2-logo.png')
