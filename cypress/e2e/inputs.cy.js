...
describe('Inputs', () => {
  it('should throw console error about unexpected input type', () => {
    ...
    expect(spy).to.be.calledWith(
      'SoftAlert2: Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "invalid-input-type"'
    )
  })
  ...
  it('input url + built-in url validation', (done) => {
    const invalidUrl = 'github.com/softinvest/softalert2'
    const validUrl = 'https://github.com/softinvest/softalert2/'
  ...
  it('input type "select", inputOptions Map with only optgroup options', () => {
    ...
    libOptGroupOptions.set('1000', 'SoftAlert2')
    ...
    expect($('.swal2-select optgroup:nth-child(2) option:nth-child(1)').innerHTML).to.equal('SoftAlert2')
  ...
  it(`returnInputValueOnDeny: true should throw warning if the input params isn't set`, () => {
    ...
    Swal.clickDeny()
    expect(spy.calledWith('SoftAlert2: The "input" parameter is needed to be set when using returnInputValueOnDeny'))
      .to.be.true
  })
  ...
  it('should throw console error about unexpected type of InputOptions', () => {
    ...
    expect(spy.calledWith('SoftAlert2: Unexpected type of inputOptions! Expected object, Map or Promise, got string'))
      .to.be.true
  })
...
describe('inputValue', () => {
  ...
  it('should throw console error when inputValue as a Promise rejects', (done) => {
    ...
    SwalWithoutAnimation.fire({
      ...
      didOpen: () => {
        setTimeout(() => {
          expect(spy.calledWith('SoftAlert2: Error in inputValue promise: Error: input promise rejected')).to.be.true
          done()
        }, TIMEOUT)
      },
    })
  ...
  it('should throw console warning about unexpected type of inputValue for input: text', () => {
    ...
    expect(
      spy.calledWith(
        'SoftAlert2: Unexpected type of inputValue! Expected "string", "number" or "Promise", got "undefined"'
      )
    ).to.be.true
  })
  ...
  it('should throw console warning about unexpected type of inputValue for input: textarea', () => {
    ...
    expect(
      spy.calledWith(
        'SoftAlert2: Unexpected type of inputValue! Expected "string", "number" or "Promise", got "object"'
      )
    ).to.be.true
  })
